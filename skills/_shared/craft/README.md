...
> Imported verbatim from [nexu-io/open-design](https://github.com/nexu-io/open-design) (MIT). Original attribution to [refero_skill](https://github.com/referodesign/refero_skill) preserved in each source file. References to OD's daemon, lint-artifact, or `var(--accent)` token apply to OD's runtime; in this repo skills opt in by reading the file, not by daemon injection.
